...
<xsl:template match="/">
       ...
       <TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
        <TR> 
          <TD WIDTH="100%" HEIGHT="40" class="uportal-background-light"> 
            <P ALIGN="CENTER" class="uportal-channel-strong">C A L E N D R I E R &#160;&#160;D ' E X A M E N S</P> 
          </TD>
        </TR>
      </TABLE>
      <xsl:choose>
      ...
      <TABLE BORDER="0" CELLPADDING="2" CELLSPACING="0" WIDTH="100%">
        <TR> 
          ...
          <TD WIDTH="70%" class="uportal-channel-strong">Liste des calendriers d'examen
		...
		<TR onMouseOver="javascript:this.className='uportal-background-highlight'" onMouseOut="javascript:this.className='uportal-background-content'">
          ...
          <TD class="uportal-text">
                <a href="{$baseActionURL}?action=calExamPageInfo&amp;etp={etp}&amp;vet={vet}">
